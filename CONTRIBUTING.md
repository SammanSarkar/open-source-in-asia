# Contributing to Asian Open Source Communities

Thank you for your interest in contributing to our database of Asian open source communities! This document provides guidelines for adding new communities and making other contributions.

## Adding a New Community

### Option 1: Create a GitHub Issue

1. Go to the [Issues](https://github.com/yourusername/asian-oss-communities/issues) tab
2. Click "New Issue"
...
4. Fill in the following information:
   ...
   - Website URL
   - Region (e.g., East Asia, South Asia, Southeast Asia)
...
- **Region**: One of: East Asia, South Asia, Southeast Asia, Central Asia
